              ...
              <HStack>
                ...
                {editMode[day] ? (
                  <RadioGroup
                    ...
                    onChange={(value) =>
                      handleRadioChange(value, 'workout', day)
                    }
                  >
                ...
                <>
                  <HStack>
                    ...
                    {editMode[day] ? (
                      ...
                      <Text>
                        Calories Burned:{' '}
                        {weeklyData[day]?.caloriesBurned || 'N/A'}
                      </Text>
                    )}
                  </HStack>
                  <HStack>
                    ...
                    {editMode[day] ? (
                      ...
                      // </Select>
                      <Text>
                        Steps Taken: {weeklyData[day]?.stepsTaken || 'N/A'}
                      </Text>
                    )}
                  </HStack>
                  <HStack>
                    ...
                    {editMode[day] ? (
                      ...
                      // </Select>
                      <Text>
                        Duration: {weeklyData[day]?.workoutDuration || 'N/A'}
                      </Text>
                    )}
                  </HStack>
                </>
              )}
              {weeklyData[day]?.lastUpdated &&
                weeklyData[day]?.lastUpdatedTime && (
                  <VStack
                    align="start"
                    position="absolute"
                    bottom="10px"
